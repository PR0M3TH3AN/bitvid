...
| **NIP-07** | `window.nostr` Capability | `js/nostr/nip07Permissions.js`, `js/nostr/adapters/nip07Adapter.js` | Compliant | Verified in `tests/compliance/nip07_compliance.test.mjs`. |
...
| **NIP-18** | Reposts | `js/nostrEventSchemas.js` | Compliant | Implements Kind 6 and 16. |
...
| **Kind 0** | Profile Metadata | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 1** | Share | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 4** | Legacy DM | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 5** | Deletion | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 6** | Repost | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 7** | Reaction | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 13** | Seal | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 14** | Chat Message | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 16** | Generic Repost | `js/nostrEventSchemas.js` | Compliant | Implemented. |
...
| **Kind 1059** | Gift Wrap | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 1111** | Video Comment | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 1984** | Report | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 9734** | Zap Request | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 9735** | Zap Receipt | `js/nostrEventSchemas.js` | Compliant | Implemented. |
...
| **Kind 10050** | DM Relay List | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 20001** | DM Read Receipt | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 20002** | DM Typing | `js/nostrEventSchemas.js` | Compliant | Implemented. |
| **Kind 27235** | HTTP Auth | `js/services/r2Service.js` | Compliant | Implemented. |
