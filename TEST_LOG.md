...
# Subtest: NIP-07 Compliance: Retry Logic
    ...
    ok 3 - runNip07WithRetry fails after max retries or if error is not timeout
      ---
      duration_ms: 1.464623
      type: 'test'
      ...
    1..3
ok 30 - NIP-07 Compliance: Retry Logic
  ---
  duration_ms: 26.916078
  type: 'test'
  ...
...
# Subtest: js/designSystem/dynamicStyles.js
    ...
    # Subtest: Isolation
        ...
        ok 1 - should manage scopes independently for different documents
          ---
          duration_ms: 18.181094
          type: 'test'
          ...
        1..1
    ok 4 - Isolation
      ---
      duration_ms: 18.357129
      type: 'suite'
      ...
    # Subtest: Edge cases
        ...
        ok 3 - should fallback to <style> element if CSSStyleSheet is missing
          ---
          duration_ms: 15.575747
          type: 'test'
          ...
        1..3
    ok 5 - Edge cases
      ---
      duration_ms: 34.719566
      type: 'suite'
      ...
    1..5
ok 33 - js/designSystem/dynamicStyles.js
  ---
  duration_ms: 274.473294
  type: 'suite'
  ...
# Subtest: Documentation Accuracy Verification
    ...
    ok 4 - should mention 2GB limit recommendation in docs and HTML
      ---
      duration_ms: 0.345391
      type: 'test'
      ...
    1..4
ok 34 - Documentation Accuracy Verification
  ---
  duration_ms: 12.840342
  type: 'suite'
  ...
...
# Subtest: NostrClient
    # Subtest: Initialization
        ...
        ok 1 - should initialize with default state
          ---
          duration_ms: 4.173196
          type: 'test'
          ...
        1..1
    ok 1 - Initialization
      ---
      duration_ms: 5.358035
      type: 'suite'
      ...
    ...
    # Subtest: subscribeVideos
        ...
        ok 1 - should subscribe to video events and buffer them
          ---
          duration_ms: 301.493098
          type: 'test'
          ...
        1..1
    ok 3 - subscribeVideos
      ---
      duration_ms: 301.951454
      type: 'suite'
      ...
    # Subtest: fetchVideos
...
# Subtest: countDiagnostics
    # Subtest: isVerboseDiagnosticsEnabled
        ...
        ok 4 - should fall back to isVerboseDevMode if window flag is not boolean
          ---
          duration_ms: 0.410499
          type: 'test'
          ...
        1..4
    ok 1 - isVerboseDiagnosticsEnabled
      ---
      duration_ms: 3.622169
      type: 'suite'
      ...
    # Subtest: logRelayCountFailure
        ...
        ok 4 - should handle empty or non-string relay URLs
          ---
          duration_ms: 0.312889
          type: 'test'
          ...
        1..4
    ok 2 - logRelayCountFailure
      ---
      duration_ms: 2.601397
      type: 'suite'
      ...
    # Subtest: Other Loggers
        ...
        ok 3 - should log view count failure once
          ---
          duration_ms: 0.326552
          type: 'test'
          ...
        1..3
    ok 3 - Other Loggers
      ---
      duration_ms: 1.420534
      type: 'suite'
      ...
...
# Subtest: dmDecryptDiagnostics
    # Subtest: summarizeDmEventForLog
        ...
        ok 7 - should handle missing or invalid tags
          ---
          duration_ms: 0.256039
          type: 'test'
          ...
        1..7
    ok 1 - summarizeDmEventForLog
      ---
      duration_ms: 5.658311
      type: 'suite'
      ...
    # Subtest: sanitizeDecryptError
        ...
        ok 5 - should handle Error objects with non-string properties
          ---
          duration_ms: 0.173522
          type: 'test'
          ...
        1..5
    ok 2 - sanitizeDecryptError
      ---
      duration_ms: 1.535626
      type: 'suite'
      ...
    1..2
ok 96 - dmDecryptDiagnostics
  ---
  duration_ms: 8.212391
  type: 'suite'
  ...
...
# Subtest: EventsCacheStore
    ...
    ok 4 - persistSnapshot should respect dirty keys optimization
      ---
      duration_ms: 2.830842
      type: 'test'
      ...
    1..4
ok 103 - EventsCacheStore
  ---
  duration_ms: 31.797735
  type: 'suite'
  ...
...
# Subtest: maxListenerDiagnostics
    ...
    # Subtest: process.emitWarning patch
        ...
        ok 1 - should have patched process.emitWarning
          ---
          duration_ms: 0.346911
          type: 'test'
          ...
        1..1
    ok 3 - process.emitWarning patch
      ---
      duration_ms: 0.499912
      type: 'suite'
      ...
    1..3
ok 106 - maxListenerDiagnostics
  ---
  duration_ms: 10.710267
  type: 'suite'
  ...
...
# Subtest: Nip46Connector
    ...
    # Subtest: prepareHandshake
        ...
        ok 1 - should parse connection string and return details
          ---
          duration_ms: 1.265218
          type: 'test'
          ...
        1..1
    ok 2 - prepareHandshake
      ---
      duration_ms: 1.426242
      type: 'suite'
      ...
    # Subtest: connect
        ...
        ok 1 - should connect directly if remote pubkey is known
          ---
          duration_ms: 2.418882
          type: 'test'
          ...
        1..1
    ok 3 - connect
      ---
      duration_ms: 2.583972
      type: 'suite'
      ...
    ...
    # Subtest: disconnect
        ...
        ok 1 - should clear stored session and emit change
          ---
          duration_ms: 0.530685
          type: 'test'
          ...
        1..1
    ok 5 - disconnect
      ---
      duration_ms: 0.677752
      type: 'suite'
      ...
    1..5
ok 109 - Nip46Connector
  ---
  duration_ms: 13.963888
  type: 'suite'
  ...
...
# Subtest: VideoEventBuffer
    ...
    ok 1 - Push and Flush
      ---
      duration_ms: 4.068405
      type: 'test'
      ...
    # Subtest: Latest Wins
    ok 2 - Latest Wins
      ---
      duration_ms: 0.492691
      type: 'test'
      ...
    # Subtest: Tombstone Handling
    ok 3 - Tombstone Handling
      ---
      duration_ms: 0.493939
      type: 'test'
      ...
    # Subtest: Cleanup
    ok 4 - Cleanup
      ---
      duration_ms: 0.392467
      type: 'test'
      ...
    1..4
ok 135 - VideoEventBuffer
  ---
  duration_ms: 7.407703
  type: 'test'
  ...
...
# Subtest: attachmentService
    ...
    ok 3 - caching
      ---
      duration_ms: 2.958926
      type: 'suite'
      ...
    1..3
ok 139 - attachmentService
  ---
  duration_ms: 26.460214
  type: 'suite'
  ...
# Subtest: authUtils
    ...
    ok 2 - normalizeAuthType
      ---
      duration_ms: 2.188898
      type: 'test'
      ...
    1..2
ok 140 - authUtils
  ---
  duration_ms: 6.441219
  type: 'test'
  ...
# Subtest: DiscussionCountService
    ...
    ok 8 - refreshCounts handles unsupported relays (empty perRelay)
      ---
      duration_ms: 2.720643
      type: 'test'
      ...
    1..8
ok 141 - DiscussionCountService
  ---
  duration_ms: 217.73342
  type: 'suite'
  ...
...
# Subtest: NostrService
    # Subtest: loadVideos
        ...
        ok 1 - should load cached videos and start subscription
          ---
          duration_ms: 5.716269
          type: 'test'
          ...
        1..1
    ok 1 - loadVideos
      ---
      duration_ms: 7.378311
      type: 'suite'
      ...
    # Subtest: fetchVideosByAuthors
        ...
        ok 1 - should fetch videos from relays for specific authors
          ---
          duration_ms: 3.318267
          type: 'test'
          ...
        1..1
    ok 2 - fetchVideosByAuthors
      ---
      duration_ms: 3.533818
      type: 'suite'
      ...
    1..2
ok 150 - NostrService
  ---
  duration_ms: 12.087126
  type: 'suite'
  ...
# (node:2694) ExperimentalWarning: The MockTimers API is an experimental feature and might change at any time
...
# Subtest: PlaybackService
    ...
    # Subtest: PlaybackSession Flow
        ...
        ok 1 - URL Probe Success starts playback
          ---
          duration_ms: 10.271348
          type: 'test'
          ...
        # Subtest: URL Probe Failure triggers fallback
        ok 2 - URL Probe Failure triggers fallback
          ---
          duration_ms: 14.867352
          type: 'test'
          ...
        # Subtest: Watchdog Stall triggers fallback
        ok 3 - Watchdog Stall triggers fallback
          ---
          duration_ms: 3.835699
          type: 'test'
          ...
        1..3
    ok 6 - PlaybackSession Flow
      ---
      duration_ms: 29.395457
      type: 'suite'
      ...
    1..6
ok 151 - PlaybackService
  ---
  duration_ms: 156.062403
  type: 'suite'
  ...
# (node:2701) ExperimentalWarning: The MockTimers API is an experimental feature and might change at any time
# (Use `node --trace-warnings ...` to show where the warning was created)
# Subtest: PlaybackService Forced Source Logic
    ...
    ok 5 - Forced Source 'torrent': Does NOT fallback to URL even if Torrent fails
      ---
      duration_ms: 1.716991
      type: 'test'
      ...
    1..5
ok 152 - PlaybackService Forced Source Logic
  ---
  duration_ms: 152.803288
  type: 'suite'
  ...
# (node:2708) ExperimentalWarning: The MockTimers API is an experimental feature and might change at any time
# (Use `node --trace-warnings ...` to show where the warning was created)
# Subtest: PlaybackService Ordering
    ...
    ok 1 - Playback Execution Order
      ---
      duration_ms: 18.200273
      type: 'suite'
      ...
    1..1
ok 153 - PlaybackService Ordering
  ---
  duration_ms: 20.063816
  type: 'suite'
  ...
# Subtest: profileMetadataService
    ...
    # Subtest: fetchProfileMetadata
        ...
        ok 2 - should return single profile result
          ---
          duration_ms: 0.570023
          type: 'test'
          ...
        1..2
    ok 2 - fetchProfileMetadata
      ---
      duration_ms: 1.521187
      type: 'suite'
      ...
...
# Subtest: s3Service
    ...
    # Subtest: getCorsOrigins
        ...
        ok 1 - should return current origin
          ---
          duration_ms: 112.505087
          type: 'test'
          ...
        # Subtest: should handle localhost
        ok 2 - should handle localhost
          ---
          duration_ms: 11.174191
          type: 'test'
          ...
        1..2
    ok 2 - getCorsOrigins
      ---
      duration_ms: 123.943897
      type: 'suite'
      ...
    1..2
ok 170 - s3Service
  ---
  duration_ms: 129.283333
  type: 'suite'
  ...
# Subtest: S3UploadService
    ...
    # Subtest: uploadFile
        ...
        ok 1 - validates parameters
          ---
          duration_ms: 1.097829
          type: 'test'
          ...
        # Subtest: uploads successfully
        ok 2 - uploads successfully
          ---
          duration_ms: 0.789701
          type: 'test'
          ...
        1..2
    ok 6 - uploadFile
      ---
      duration_ms: 2.406116
      type: 'test'
      ...
    # Subtest: uploadVideo
...
# Subtest: torrent/ui/toastService
    ...
    ok 1 - renders a toast with Tailwind token classes and removes it on dismiss
      ---
      duration_ms: 385.129332
      type: 'test'
      ...
    1..1
ok 198 - torrent/ui/toastService
  ---
  duration_ms: 387.051428
  type: 'suite'
  ...
...
# Subtest: CreatorProfileController
    ...
    ok 4 - fetchModalCreatorProfile fetches profile and updates modal
      ---
      duration_ms: 1.335642
      type: 'test'
      ...
    1..4
ok 200 - CreatorProfileController
  ---
  duration_ms: 6.472476
  type: 'test'
  ...
# Subtest: EngagementController
    ...
    ok 10 - handleEnsurePresenceAction - should show success on successful rebroadcast
      ---
      duration_ms: 0.486157
      type: 'test'
      ...
    1..10
ok 201 - EngagementController
  ---
  duration_ms: 13.390955
  type: 'test'
  ...
...
# Subtest: ReactionController
    ...
    ok 5 - should not react if user not logged in
      ---
      duration_ms: 0.582965
      type: 'test'
      ...
    1..5
ok 219 - ReactionController
  ---
  duration_ms: 10.236324
  type: 'suite'
  ...
...
# Subtest: cardSourceVisibility
    ...
    ok 1 - updateVideoCardSourceVisibility
      ---
      duration_ms: 26.799208
      type: 'suite'
      ...
    1..1
ok 261 - cardSourceVisibility
  ---
  duration_ms: 27.535582
  type: 'suite'
  ...
# Subtest: domUtils
    # Subtest: escapeHTML
...
# Subtest: getVideoRootIdentifier
    ...
    ok 4 - returns id when videoRootId is not a string
      ---
      duration_ms: 0.168508
      type: 'test'
      ...
    1..4
ok 293 - getVideoRootIdentifier
  ---
  duration_ms: 3.612275
  type: 'test'
  ...
...
#   videoPayloadBuilder.js                        |  91.85 |    50.00 |  100.00 | 26-27 31-32 111-113 149-150 153-154 157-158 161-162 237-239 252-254 273-274 277-278 281-282 297-298 301-302 401-402 422-423 426-427 430-431 445
...
#   moderationDecorator.js                        |  83.04 |    63.37 |   92.31 | 27-28 34-35 50 55-71 76-77 81-82 87-88 98-101 113-124 196-197 221-222 226-227 275-276 279-280 283-284 320-321 351-353 356-363 377-378 401-402 458-459 472-473 485-486 490-491 493 495-496 498-499
...
tests/watchHistory/watch-history-telemetry.test.mjs:console.log("watch-history-telemetry tests passed");
Audit completed. See test-audit-report-2026-02-12.md
