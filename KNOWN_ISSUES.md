...
_No skipped tests currently documented._ (Last checked: 2026-02-14)
...
- **Note**: Visual tests are passing as of 2026-02-12. (Agent verified 2026-02-14: Tests passing after installing browsers).
...
- **Workaround**: Run `npx playwright install` to download the required browser binaries if you are running tests outside of the pre-configured dev container or CI environment. (Last checked: 2026-02-14)
