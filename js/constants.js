import {
  ...
  FEATURE_BITLOGIN as CONFIG_FEATURE_BITLOGIN,
...
const DEFAULT_FLAGS = Object.freeze({
  ...
  // BitLogin primary sign-in method (js/ui/bitloginModalIntegration.js).
  // Default OFF; only an explicit `true` in the instance config enables it.
  FEATURE_BITLOGIN: CONFIG_FEATURE_BITLOGIN === true,
...
const runtimeFlags = (() => {
  ...
  const initial = {
    ...
    FEATURE_BITLOGIN: DEFAULT_FLAGS.FEATURE_BITLOGIN,
...
export let FEATURE_BITLOGIN = coerceBoolean(
  runtimeFlags.FEATURE_BITLOGIN,
  DEFAULT_FLAGS.FEATURE_BITLOGIN
);
